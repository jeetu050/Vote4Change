...
<%
    String userid=(String)session.getAttribute("userid");
                ...
                else if(result != null && result.equals("details"))
                {
                    ...
                    sb.append("<table><tr><td>User Id : </td><td>"+adhar_no+"</td></tr> <tr><td>Candidate Name : </td><td>"+cname+"</td> </tr>"
                            + "<tr><td>City : </td><td>"+city+"</td></tr><tr><td>Party : </td><td>"+party+"</td></tr><tr><td>Symbol : </td><td>"+image+"</td><tr></table>");
                    org.json.JSONObject json = new org.json.JSONObject();
