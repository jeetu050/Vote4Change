...
//            CandidateDTO candidate = new CandidateDTO(objValues.get(0),objValues.get(3),objValues.get(4),objValues.get(1),inp);
            boolean result = CandidateDAO.updateCandidateByCid(objValues.get(0),objValues.get(1),inp,objValues.get(2));
            if(result)
            ...
            System.out.println("Exception in UpdateNewCandidateServlet");
            ex.printStackTrace();
        }
        finally
        {
