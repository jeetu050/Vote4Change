...
public class UpdateCandidateControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("Hello My Boy : "+choosen);
            try
            {
                if(choosen != null && choosen.equals("cid"))
                {
                    ...
                    System.out.println("Inside If UpdateCandidateControllerServlet");
                ...
                else
                {
                    ...
                    System.out.println("Inside Else UpdateCandidateControllerServlet");
            ...
            catch(Exception ex)
            {
                ...
                System.out.println("Finally Inside UpdateCandidateControllerServlet");
                rd.forward(request, response);
            }
    }
