...
public class AddVoteControllerServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String gender = CandidateDAO.getGenderById(userid);
            VoteDTO vote = new VoteDTO(candidateId , userid, gender);
        ...
        {
            System.out.println("Exception in AddVoteControllerServlet");
            ex.printStackTrace();
